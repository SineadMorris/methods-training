...
Github: https://github.com/SineadMorris/methods-training
...
parameters <- c(beta = R0 * gamma, gamma = gamma)
...
plot( x = sim[, "time"], y = sim[, "S"],               # x & y variables to plot
      ...
      ylim = c(0, 1000),                               # set limits of y-axis 
...
# Add legend to plot
legend(x = 25, y = 800,                                # position (x,y) = top-left corner                
